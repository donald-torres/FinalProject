package com.skilldistillery.quickfix.security;
...
public class SecurityConfig {
    ...
    SecurityFilterChain createFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize
            ...
            .requestMatchers(HttpMethod.GET, "/api/trades").permitAll()     // will hit the OPTIONS on the route
            .requestMatchers(HttpMethod.GET, "/api/specialties").permitAll()     // will hit the OPTIONS on the route
            .requestMatchers(HttpMethod.GET, "/api/projectAreas").permitAll()     // will hit the OPTIONS on the route
